...
var notices = [
	...
	'* 大陆地区用户我们强烈建议您收藏当前页面(xjiqing.github.io)。'
];
...
window.onload = function () {
    ...
    logoElem.innerHTML = '<h1 class="flag">X激情视频</h1>'
    mainElem.appendChild(logoElem);

    // newest urls
    var newestFieldElem = createFieldElem({title: 'X激情视频最新地址', items: newestUrls, text: '请使用https://协议访问X激情视频'});
    ...
    // forever urls
    var foreverFieldElem = createFieldElem({title: 'X激情视频永久地址', items: foreverUrls});
